...
| class                                    | description                                                                                                   |
|------------------------------------------|---------------------------------------------------------------------------------------------------------------|
| `rui-switch`                             | The switch container                                                                                          |
| `rui_switch__button`                     | The switch button or input element                                                                            |
| `rui_switch__button--checked`            | The switch is enabled                                                                                         |
| `rui_switch__toggle--indicator`          | The switch toggle indicator                                                                                   |
| `rui-switch__label`                      | The switch label                                                                                              |
| `rui-switch__description`                | The switch description                                                                                        |
| `rui-switch-label-description-container` | The container for the label and description. Only available if the label and description props are available. |
